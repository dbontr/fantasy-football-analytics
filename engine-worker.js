...
self.addEventListener("message", async (event) => {
  ...
  try {
    ...
    switch (message.type) {
      ...
      case "future-win-actions": result = engine.evaluateFutureWinActions(message.options || {}); break;
      case "matchup-lineups": result = engine.evaluateMatchupLineups(message.options || {}); break;
